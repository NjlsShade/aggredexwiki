...
published: 1
date: 2019-08-12T19:55:51.929Z
tags: 
---

# About
Located in the [Sun Star System](/star-system/sun-star-system), Earth is the third planet in the barycenter orbit of [Sun], it completes its orbit in about 365.26 days, or one [Earth year]. Earth is the only known celestial object to harbor life and is believed to be over 4.5 billion years old.
...
From an average distance of 93 million miles (150 million kilometers), Earth is exactly one [astronomical unit] away from the Sun because one astronomical unit is the distance from the Sun to Earth. This unit provides an easy way to quickly compare planets' distances from the Sun.
